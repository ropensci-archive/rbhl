...
url <- 'http://www.biodiversitylibrary.org/api2/httpquery.ashx?op=GetPageMetadata&pageid=1328690&ocr=t&names=t&format=json&apikey=ea5bbfda-e6ad-4fce-b288-70fa9410a9b3'
fromJSON(url)
